...
exports.VerifyPhoneOtpDto = exports.SendPhoneOtpDto = void 0;
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: '123456', description: '6-digit OTP from SMS' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], VerifyPhoneOtpDto.prototype, "code", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Ahmed Ali', description: 'Used when auto-registering a new user' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], VerifyPhoneOtpDto.prototype, "name", void 0);
